...
public class SelectRoleNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(SelectRoleNodePlugin.currentVersion, 
				Collections.singletonList(SelectRoleNode.class));
	}
	...
	public String getPluginVersion() {
		return SelectRoleNodePlugin.currentVersion;
	}
}
