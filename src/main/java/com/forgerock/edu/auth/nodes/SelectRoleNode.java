...
public class SelectRoleNode extends SingleOutcomeNode {
    ...
    public Action process(TreeContext context) throws NodeProcessException {
        ...
        // DONE Ch2L2Ex2 Task7: Get the authenticated user's AMIdentity object by using the coreWrapper's getIdentity method.
        // DONE Ch2L2Ex2 Task7:   Hint: Use CoreWrapper.getIdentity(String username, String realm) method
